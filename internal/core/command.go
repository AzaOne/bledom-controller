...
const (
	...
	CmdUpdateSchedule     CommandType = "updateSchedule"
	CmdRemoveSchedule     CommandType = "removeSchedule"
	CmdRunScheduleNow     CommandType = "runScheduleNow"
	CmdSetScheduleEnabled CommandType = "setScheduleEnabled"
	CmdSetAllSchedules    CommandType = "setAllSchedulesEnabled"
